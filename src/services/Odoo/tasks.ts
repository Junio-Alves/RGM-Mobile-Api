...
export const odooFetchTasks = async (project_id: number,user_partner_id: number,showAllTasks:boolean,onlyInProgress:boolean, task_id?:number,parent_id?:number) => {
    try {
        const domain: any[] = [["project_id", "=", project_id]];
